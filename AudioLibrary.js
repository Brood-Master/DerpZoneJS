...
this[CHANNEL.name].audioLibrary.sounds = {
    ...
    noscope: {
        url: "http://soundboard.panictank.net/GET%20NOSCOPED.mp3",
        emote: true,
        squee: true
    },
    sandstorm: {
        url: "http://upload.wikimedia.org/wikipedia/en/3/3f/Darude_-_Sandstorm.ogg",
        emote: true,
        squee: false
    },
    wahaha: {
    ...
    squee: {
        url: "https://resources.pink.horse/sounds/squee.ogg",
        emote: true,
        squee: true
    }
};
