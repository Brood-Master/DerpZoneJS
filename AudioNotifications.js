...
if (!window[CHANNEL.name]) {
    ...
    const AudioNotifier = function() {
        ...
        this.choices = Object.assign({}, {
            squee: "https://cdn.discordapp.com/attachments/701588063616499792/706984176250912879/squee.ogg",
            votingpoll: "https://cdn.discordapp.com/attachments/701588063616499792/706984179556155462/votingpoll.ogg",
            uhoh: "https://cdn.discordapp.com/attachments/701588063616499792/706984178092212354/uhoh.ogg",
            fairywand: "https://cdn.discordapp.com/attachments/701588063616499792/706984174837563453/fairy_wand.ogg",
            bell: "https://cdn.discordapp.com/attachments/701588063616499792/706984173050658916/bell.ogg"
        ...
        this.handler = {
            ...
            Poll: function(data) {
                if (!this.Poll.toggleState) {
                    return
                }
                if (CLIENT.rank < CHANNEL.perms.pollvote) {
                    return
                }
                if (Date.now() - this.Poll.timeSinceLast < 36e4) {
                    return
                }
            ...
            Marked: function(uid) {
                ...
                if (typeof window.unremoveVideo == "function") {
                    window.unremoveVideo()
                }
            }.bind(this)
        };
        return this
